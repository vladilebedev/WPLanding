		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Адрес', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[adrestext]" class="regular-text" type="text" name="sample_theme_options[adrestext]" value="<?php esc_attr_e( $options['adrestext'] ); ?>" />
					</td>
				</tr>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Вэб-сайт', 'sampletheme' ); ?></th>
					<td>
