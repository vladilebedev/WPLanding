            ...
            <div class="row">
                ...
                <div id="portfolio_grid">
                    ...
                    <?php if ( have_posts() ) : query_posts('cat=7');
                        /*для обратной сорт-ки вместо query_posts('cat=7'); использовать query_posts('cat=7&orderby=ID&order=DESC')*/
                        while (have_posts()) : the_post(); ?>
    ...
    <div class="section_content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <form action="https://formspree.io/vlaleb92@mail.ru" class="main_form" novalidate target="_blank" method="post">
                        <!--в оригинале файла jsBootstrapVal-n не form-group, а control-group-->
